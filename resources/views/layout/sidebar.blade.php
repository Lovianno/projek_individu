<ul style="background-image: radial-gradient(circle,yellow,orange,orangered ,red,black,black 50%)" class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar">
